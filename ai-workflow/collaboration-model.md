...
本文是 DayPalette 共享层 AI 协作方法论真相源，同时保留已归档旧多仓方案的历史上下文。

> 归档提示：自 2026-04-29 起，`daypalette-color-assets` 与 `daypalette-palette-workbench` 已退出当前规划。涉及这两个仓库的描述仅保留为历史背景，统一说明见 [`../archive/color-operations-reset-2026-04.md`](../archive/color-operations-reset-2026-04.md)。
...
- `daypalette-color-assets`（原配色资产 source / bundle）
- `daypalette-palette-workbench`（原策展工作台 Web）

> 本文只描述**通用模型与原则**。每个当前存续仓的具体落盘清单、目录结构、技术细则放在各仓内部（例如 `day_palette/docs/ai-workflow/00-AI-DEVELOPMENT-HARNESS.md`）。
...
| `daypalette-docs` | [`daypalette-docs/AGENTS.md`](../AGENTS.md) | 共享文档写作边界、归档治理与协作原则 |
| 已归档旧多仓方案 | [`archive/color-operations-reset-2026-04.md`](../archive/color-operations-reset-2026-04.md) | 旧 `daypalette-color-assets` / `daypalette-palette-workbench` 的统一归档入口 |
